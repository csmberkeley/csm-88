\begin{blocksection}
\question Lets use OOP to help us implement the ping-pong sequence!
...
Assume you have a function \texttt{has\_seven(k)} that returns True if $k$ contains the digit 7. (Extra challenge write \texttt{has\_seven(k)} yourself with recursion!)
